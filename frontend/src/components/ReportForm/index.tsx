                    ...
                    <form class="space-y-4 py-[60px] px-[70px]" method="POST" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <div class="flex space-x-2">
                                <button type="button" class="btn btn-secondary" onClick={() => setShowChoiceModal(true)}>Choose</button>
                                {imagePreview() && (
                            ...
                            {showChoiceModal() && (
                                <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                                    <div class="bg-white p-4 rounded shadow-lg">
                                        ...
                                        <button type="button" class="btn btn-primary w-full mb-2" onClick={() => document.getElementById('cameraInput').click()}>Take a Picture</button>
                                        ...
                                        <button type="button" class="btn btn-outline w-full mt-2" onClick={() => setShowChoiceModal(false)}>Cancel</button>
                                    </div>
                                </div>
                            )}
                            {loading() && (
                        ...
                        <div class="">
                            <button type="submit" class="btn btn-block button-primary">SEND</button>
                        </div>
                    </form>
                </div>
            </div>
